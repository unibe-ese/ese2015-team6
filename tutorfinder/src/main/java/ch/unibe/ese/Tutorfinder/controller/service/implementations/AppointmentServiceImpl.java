...
public class AppointmentServiceImpl implements AppointmentService {
	...
	public List<AppointmentPlaceholder> loadAppointments(List<Timetable> slots, User tutor, LocalDate date) {
		...
		tmpList.sort(new AppointmentPlaceholderComparator());
		return tmpList;
	}
	...
	/**
	 * Class to compare {@link AppointmentPlaceholder} on the {@code Timeslot}
	 *
	 */
	private static class AppointmentPlaceholderComparator implements Comparator<AppointmentPlaceholder>, Serializable{
		
		/**
		 * Autogenerated serialVersion
		 */
		private static final long serialVersionUID = 1265420254398492036L;
